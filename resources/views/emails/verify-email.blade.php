...
<head>
    ...
    <title>Vérifiez votre email - HOMIQIO</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p>
            Merci de vous être inscrit sur HOMIQIO ! Pour finaliser votre inscription 
        ...
        <p>
            Ce lien expirera dans 24 heures. Si vous n'avez pas créé de compte sur HOMIQIO, 
